...
function Home() {
    return (
        <div className="relative flex flex-col min-h-screen bg-[url('/index-background.jpg')] bg-opacity-50 bg-repeat bg-[length:80px] bg-center overflow-hidden">
            <div className="flex-1 bg-white bg-opacity-20">
                <MetaHead title="Darrow Wolf" />
                <main className="main h-full">
                    <Header text=""/>
                    <div className="bg-white px-4 md:px-12 pt-16 pb-20 shadow-2xl shadow-black/[0.2] rounded-3xl text-center flex-shrink-0 flex-col justify-center max-w-md transition-colors dark:bg-neutral-800 my-4 mx-4 md:mx-auto md:w-3/4 lg:w-2/3">
                        {/* Profile Card*/}
